...
class SymbolTable:
    ...
    def declareVariable(self, variable: str, value: Union[int, str, bool], varType: str) -> NoReturn:
        if variable in self.table:
            raise NameError(f"Variable {variable} already declared")
        self.table[variable] = {"value": value, "varType": varType}

    def setVariable(self, variable: str, value: Union[int, str, bool], varType: str) -> NoReturn:
